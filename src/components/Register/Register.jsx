                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 h-full">
                      ...
                      <div className="md:flex-grow flex flex-col md:flex-row items-start ">
                        <div className="md:mr-4 lg:mr-[30px] ">
                          ...
                          <input
                            ...
                            name="name"
                            id="name"
                            className="h-10 border mt-1 rounded px-4 w-full md:w-full bg-gray-50 lg:w-[300px] "
                            value={formData.name}
                    ...
                    <div className="md:col-span-5">
                      <label className="text-xl" htmlFor="birthdate">
                        Date of Birth
                      </label>
                      <input
                        type="date"
                    ...
                    <div className="md:col-span-5 lg:flex ">
                      <div className="password lg:mr-[30px] ">
                        ...
                        <input
                          ...
                          name="password"
                          id="password"
                          className="h-10 border mt-1 rounded px-4 lg:w-[300px] w-full block bg-gray-50"
                    ...
                    <div className="md:col-span-1">
                      <label className="text-xl" htmlFor="zipcode">
                        Zipcode
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="md:col-span-5 text-right">
                      <div className="inline-flex items-end">
                        <button
                          type="submit"
                          className="bg-primary hover:bg-white border-2 hover:text-primary hover:border-primary hover:border-2 text-white font-bold py-2 px-4 rounded"
