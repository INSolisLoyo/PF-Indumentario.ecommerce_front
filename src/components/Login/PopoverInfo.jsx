          ...
          <>
            ...
            >
              <Popover.Panel className="absolute left-1/2 z-10 mt-3 w-40 max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
                <div className="bg-[#fae8e6] overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5 flex justify-center text-center p-4">
                  <p className='text-sm'>To enjoy a safer shopping experience, we recommend using this option only on your personal devices.</p>
                </div>
              </Popover.Panel>
            </Transition>
          </>
