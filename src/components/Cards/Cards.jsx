...
const Cards = () => {
  ...
  const handleAddToCart = (productId) => {
    ...
    // Mensaje de éxito o actualización del carrito, si es necesario
  ...
  return (
    ...
    <div className="flex-col pt-[120px] justify-center font-RedHat">
        ...
        >
          {displayedItems.map((res) => (
            <div key={res.id} className="relative">
              ...
              <button onClick={() => handleAddToCart(res.id)}>Add to Cart</button>
              <Card res={res} />
            </div>
          ))}
        </div>
      ...
      {/* Mostramos el número de elementos en el carrito */}
