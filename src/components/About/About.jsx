  ...
  return (
    ...
    <div className="w-full h-auto pt-28 md:pt-40">
      ...
      <div className="absolute inset-x-6 top-[100px]">
        <button
              className=" px-6 py-2 leading-5 text-black transition-colors duration-200 transform bg-secondary/35 rounded-md hover:bg-primary hover:text-white italic font-bold focus:outline-none "
      ...
      <div className="w-11/12 mx-auto h-auto flex gap-8">
        ...
        <div className="hidden font-RedHat md:w-3/12 md:pl-4 md:flex md:flex-col md:gap-4">
          ...
          <div className="flex flex-col gap-2 font-RedHat px-4">
            {section === "aboutUs" &&
              displayContent === true &&
              sectionPartsAbout.map((part, index) => {
                if (index === 0)
                  return (
                    <p
                      className="text-lg text-[#5f352f] cursor-pointer"
                      key={part}
                    >
                      {part}
                    </p>
                  ...
                  return (
                    <p className="text-[#5f352f] cursor-pointer" key={part}>
                      {part}
                    </p>
                  );
              })}
        ...
        {section === "aboutUs" ? (
          <AboutUs setSectionPartsAbout={setSectionPartsAbout} />
        ) : section === "termsAndConditions" ? (
          <TermsAndConditions setSectionPartsAbout={setSectionPartsAbout} />
        ) : (
          <Privacy setSectionPartsAbout={setSectionPartsAbout} />
        )}
      </div>
    </div>
  );
