...
const CartMenu = () => {
  ...
  const handleIncreaseQuantity = async (product) => {
    ...
    if (product.quantity < maxItems) {
      ...
      if (product.product && product.product.id) { // Verificar que product.product y product.product.id estén definidos
        // await updateCartItem(product.product.id, updatedQuantity);
        increaseQuantity(
          product.product.id,
        ...
        console.error("Error updating cart item: Invalid product object");
      }
    }
  };
  ...
  const updateCartItem = async (productId, quantity) => {
    try {
      ...
      await axios.put(`/cart/${user.id}`, payload);
    } catch (error) {
