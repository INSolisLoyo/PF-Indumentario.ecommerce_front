          ...
          <div className="grid grid-cols-1 gap-6 p-8 rounded-xl sm:grid-cols-2 bg-white">
            ...
            <div>
              ...
              <input
                ...
                className={`${ disabledData ? "text-gray-500 cursor-not-allowed bg-gray-100" : "text-gray-700 cursor-pointer bg-white"} block w-full px-4 py-2 mt-2 border border-gray-300 rounded-md   focus:outline-none focus:ring`}
              />
              {errors.name && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                disabled={disabledData}
                className={`${ disabledData ? "text-gray-500 cursor-not-allowed bg-gray-100" : "text-gray-700 cursor-pointer bg-white"} block w-full px-4 py-2 mt-2 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring`}
              />
              {errors.price && (
            ...
            <div className="flex flex-col gap-4">
              ...
              <select name="category" id="category"  className={`${ disabledData ? "bg-gray-100 cursor-not-allowed" : "bg-primary/10 cursor-pointer"}py-2 px-4 rounded-xl`} defaultValue={form.category} onChange={handleChange} disabled={disabledData}>
                {
            ...
            <div>
             ...
             <div className="w-full flex flex-col justify-center">
              ...
              <div className="w-full flex justify-around gap-4">
                ...
                <button className={`${ disabledData ? "text-gray-500 cursor-not-allowed bg-gray-100" : "text-gray-700 cursor-pointer bg-primary/10 hover:bg-primary hover:text-white"} w-1/2 px-6 py-2 mt-2 leading-5 text-black transition-colors duration-200 transform  rounded-md focus:outline-none focus:bg-gray-600`} onClick={uploadPicture} disabled={disabledData}>Upload Image</button>
