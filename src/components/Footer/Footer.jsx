        ...
        <div className="grid md:grid-cols-12 grid-cols-1 gap-4">
          <div className="lg:col-span-4 col-span-12">
            <a href="/" className="w-auto h-auto">
              <img className="w-48 h-56 mx-auto" src={logo} alt="logo" />
            </a>
              ...
              <li className="inline">
                ...
                >
                  <svg
                    ...
                    className="h-10 w-10 fill-[#c17b60] hover:fill-gray-300"
                    viewBox="0 0 24 24"
                  >
          ...
          <div className="lg:col-span-2 md:col-span-4 col-span-12">
            <h5 className="tracking-wide text-[#c17b60] font-semibold">
              Company
            </h5>
          ...
          <div className="lg:col-span-3 md:col-span-4 col-span-12">
            ...
            <p className="mt-5">
              Sing up and receive the latest tips via email.
            </p>
            <form action="">
              <div className="my-3">
