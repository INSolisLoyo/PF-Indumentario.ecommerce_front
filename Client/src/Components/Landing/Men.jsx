...
const Men = () => {
  return (
    <div className="relative flex flex-col-reverse mb-12 justify-around w-[90%] h-[60vh] content-center items-center 2xl:flex-row">
      <div className="relative z-10">
        <OneSlider gender={"male"} />
      </div>
      <div className="text-center relative z-20">
        <h1 className="text-2xl tracking-[.25em] font-bold sm:text-3xl md:text-3xl lg:text-4xl xl:text-4xl">
          MEN
        </h1>
